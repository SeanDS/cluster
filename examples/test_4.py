...
problem.add_variable('laser')
problem.add_variable('sm1')
problem.add_variable('sm2')
problem.add_variable('mc1bk')
problem.add_variable('mc1fr')
problem.add_variable('mc2')
problem.add_variable('mc3fr')
problem.add_variable('mc3bk')
problem.add_variable('im1')
problem.add_variable('im2')
problem.add_variable('im3')
problem.add_variable('im4')
problem.add_variable('prmbk')
problem.add_variable('prmfr')
problem.add_variable('pr2')
problem.add_variable('pr3')
problem.add_variable('bsfr')
problem.add_variable('bsbk')
problem.add_variable('itmy')
problem.add_variable('etmy')
problem.add_variable('itmx')
problem.add_variable('etmx')
problem.add_variable('sr3')
problem.add_variable('sr2')
problem.add_variable('srm')
problem.add_variable('om1')
problem.add_variable('om2')
problem.add_variable('om3')
problem.add_variable('omc1')
problem.add_variable('omc2')
problem.add_variable('omc3')
problem.add_variable('omc4')
problem.add_variable('omc5')
