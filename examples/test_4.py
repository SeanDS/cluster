...
problem.add_constraint(AngleConstraint('laser', 'sm1', 'sm2', math.radians(45)))
problem.add_constraint(DistanceConstraint('sm1', 'sm2', 25))
problem.add_constraint(DistanceConstraint('sm2', 'mc1bk', 25))
problem.add_constraint(AngleConstraint('sm1', 'sm2', 'mc1bk', math.radians(-50)))
problem.add_constraint(DistanceConstraint('mc1bk', 'mc1fr', mc1_light_travel_path))
problem.add_constraint(AngleConstraint('sm2', 'mc1bk', 'mc1fr', math.radians(mc1_aoi)))
problem.add_constraint(AngleConstraint('mc1bk', 'mc1fr', 'mc2', math.radians(-mc1_aoi)))

# IMC angles together with mc1->mc3 length set the length length
problem.add_constraint(DistanceConstraint('mc1fr', 'mc3fr', 25))
problem.add_constraint(AngleConstraint('mc1fr', 'mc3fr', 'mc2', math.radians(-imc_opening_angle)))
problem.add_constraint(AngleConstraint('mc3fr', 'mc1fr', 'mc2', math.radians(imc_opening_angle)))

problem.add_constraint(AngleConstraint('mc2', 'mc3fr', 'mc3bk', math.radians(-mc1_aoi)))
problem.add_constraint(DistanceConstraint('mc3fr', 'mc3bk', mc3_light_travel_path))
problem.add_constraint(AngleConstraint('mc3fr', 'mc3bk', 'im1', math.radians(mc1_aoi)))
problem.add_constraint(DistanceConstraint('mc3bk', 'im1', 50))
problem.add_constraint(AngleConstraint('mc3bk', 'im1', 'im2', math.radians(100)))
problem.add_constraint(DistanceConstraint('im1', 'im2', 100))
problem.add_constraint(DistanceConstraint('im2', 'im3', 90))
problem.add_constraint(AngleConstraint('im1', 'im2', 'im3', math.radians(10)))
problem.add_constraint(AngleConstraint('im2', 'im3', 'im4', math.radians(-10)))
problem.add_constraint(DistanceConstraint('im3', 'im4', 90))
problem.add_constraint(AngleConstraint('im3', 'im4', 'prmbk', math.radians(74)))
...
problem.add_constraint(AngleConstraint('im4', 'prmbk', 'prmfr', math.radians(180)))
problem.add_constraint(DistanceConstraint('prmfr', 'pr2', 200))
problem.add_constraint(AngleConstraint('prmbk', 'prmfr', 'pr2', math.radians(180)))
problem.add_constraint(DistanceConstraint('pr2', 'pr3', 160))
problem.add_constraint(AngleConstraint('prmfr', 'pr2', 'pr3', math.radians(15)))
problem.add_constraint(DistanceConstraint('pr3', 'bsfr', 250))
problem.add_constraint(AngleConstraint('pr2', 'pr3', 'bsfr', math.radians(-15)))

problem.add_constraint(DistanceConstraint('bsfr', 'bsbk', bs_light_travel_path))
problem.add_constraint(AngleConstraint('pr3', 'bsfr', 'bsbk', math.radians(bs_aoi)))
problem.add_constraint(DistanceConstraint('bsfr', 'itmy', 75))
problem.add_constraint(AngleConstraint('pr3', 'bsfr', 'itmy', math.radians(90)))
problem.add_constraint(DistanceConstraint('itmy', 'etmy', l_arm))
problem.add_constraint(AngleConstraint('bsfr', 'itmy', 'etmy', math.radians(180)))
...
problem.add_constraint(AngleConstraint('bsfr', 'bsbk', 'itmx', math.radians(-bs_aoi)))
problem.add_constraint(DistanceConstraint('itmx', 'etmx', l_arm))
problem.add_constraint(AngleConstraint('bsbk', 'itmx', 'etmx', math.radians(180)))

problem.add_constraint(DistanceConstraint('bsbk', 'sr3', 75))
problem.add_constraint(AngleConstraint('itmx', 'bsbk', 'sr3', math.radians(100)))
problem.add_constraint(DistanceConstraint('sr3', 'sr2', 50))
problem.add_constraint(AngleConstraint('bsbk', 'sr3', 'sr2', math.radians(-10)))
problem.add_constraint(DistanceConstraint('sr2', 'srm', 60))
problem.add_constraint(AngleConstraint('sr3', 'sr2', 'srm', math.radians(-10)))
problem.add_constraint(DistanceConstraint('srm', 'om1', 70))
problem.add_constraint(AngleConstraint('sr2', 'srm', 'om1', math.radians(180)))
problem.add_constraint(DistanceConstraint('om1', 'om2', 40))
problem.add_constraint(AngleConstraint('srm', 'om1', 'om2', math.radians(-15)))
problem.add_constraint(DistanceConstraint('om2', 'om3', 30))
problem.add_constraint(AngleConstraint('om1', 'om2', 'om3', math.radians(25)))
problem.add_constraint(DistanceConstraint('om3', 'omc1', 10))
problem.add_constraint(AngleConstraint('om2', 'om3', 'omc1', math.radians(-90)))
problem.add_constraint(DistanceConstraint('omc1', 'omc2', 5))
problem.add_constraint(AngleConstraint('om3', 'omc1', 'omc2', math.radians(-90)))
problem.add_constraint(AngleConstraint('omc1', 'omc2', 'omc3', math.radians(180)))
problem.add_constraint(DistanceConstraint('omc2', 'omc3', 30))
problem.add_constraint(AngleConstraint('omc2', 'omc3', 'omc4', math.radians(30)))
problem.add_constraint(AngleConstraint('omc3', 'omc2', 'omc4', math.radians(-90)))
problem.add_constraint(AngleConstraint('omc4', 'omc5', 'omc2', math.radians(-30)))
problem.add_constraint(AngleConstraint('omc3', 'omc4', 'omc5', math.radians(-30)))
...
print("Root = " + str(solver.solver._graph.outgoing_vertices('_root')))
