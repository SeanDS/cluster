...
problem.add_point('laser')
problem.add_point('sm1')
problem.add_point('sm2')
problem.add_point('mc1bk')
problem.add_point('mc1fr')
problem.add_point('mc2')
problem.add_point('mc3fr')
problem.add_point('mc3bk')
problem.add_point('im1')
problem.add_point('im2')
problem.add_point('im3')
problem.add_point('im4')
problem.add_point('prmbk')
problem.add_point('prmfr')
problem.add_point('pr2')
problem.add_point('pr3')
problem.add_point('bsfr')
problem.add_point('bsbk')
problem.add_point('itmy')
problem.add_point('etmy')
problem.add_point('itmx')
problem.add_point('etmx')
problem.add_point('sr3')
problem.add_point('sr2')
problem.add_point('srm')
problem.add_point('om1')
problem.add_point('om2')
problem.add_point('om3')
problem.add_point('omc1')
problem.add_point('omc2')
problem.add_point('omc3')
problem.add_point('omc4')
problem.add_point('omc5')
